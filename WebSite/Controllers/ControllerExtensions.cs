...
namespace Site.Controllers
{
    public static class ControllerExtensions
    {
                                                ...
                                                TempDataDictionary tempData)
        {
            ...
            {
                viewPage.ViewContext = new ViewContext(controller.ControllerContext, new WebFormView(controller.ControllerContext, viewPath), viewData, tempData, writer);
                                                   ...
                                                   string controlName, object viewData)
        {
            ...
            using (StringWriter sw = new StringWriter(sb))
            {
                ...
                {
                    var viewContext = new ViewContext(controller.ControllerContext, new WebFormView(controller.ControllerContext, "FAKEVIEW"), new ViewDataDictionary(viewData), new TempDataDictionary(), tw);
