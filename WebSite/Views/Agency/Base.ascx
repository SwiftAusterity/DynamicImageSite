...
<div class="block left">
    <div class="intro">
        <section>
            ...
            <div class="content">
                <p>We stay pretty busy creating digital solutions for our clients, but life here isn't all work and no play. Our lives outside of work drive our experiences and thinking just as much as the creative problem solving we do each day.
                </p>
              </div>
            <footer>
            </footer>
            ...
            <div class="content">
                ...
                <div class="video-container">
                    <div class="video-bigbutton">
                        <img alt="" src="/Content/images/Agency/People_Big.jpg">
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        window.Infuz.PageTransition.addPaneCallback(
            '<%= viewId %>',
            function() {
                window.Infuz.Utility.loadVideoContent($videoSection.get(), '26985276', 448, 252, true);
            }
        );
    });
</script>
