...
(function($) {
    ...
    $.extend({
        routes: {
            ...
            add: function(route, name, area, section, defaults, func) {
                // parameter overload
                ...
                return this.list[name] = {
                    ...
                    execute: function(data) {
                        this.func.apply($.extend({}, defaults, this.route));
                    },
                    vars: vars,
                    defaults: defaults,
            ...
            findRoute: function(hash) {
                ...
                $.each(this.list, function(i, match) {
                    ...
                    //f- regexp for this, it breaks missing.
                    if (this.route.toLowerCase() == hash.toLowerCase()) {
                        route = match;
                        args = exp;
                        return false;
                    }
            ...
            load: function(hash) {
                ...
                // route not found, return the "Missing" route
                if (!route || !hash) {
                    route = $.routes.findRoute('!/missing/');
                ...
                window.Infuz.Navigation.previousRoute = $.routes.current;
    ...
    $(function() {
        window.Infuz.Ajax.getRoutesFromService();
    });
} (jQuery));