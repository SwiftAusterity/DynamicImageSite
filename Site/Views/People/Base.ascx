...
<div class="block left">
    <div class="intro">
        <section>
            <header>
                <h1>They Call Us Infuzers</h1>
            </header>
            <div class="content">
                <p>We are a collective of chefs, singers, musicians, atheletes, gamers, frugalistas, pinball wizards and pop culture junkies. We love what we do and have a good time doing it.
                </p>
            </div>
            <footer>
            </footer>
            ...
            <div class="content">
                ...
                <div class="video-container">
                    <div class="video-bigbutton">
                        <img alt="" src="/Content/images/People/People_Big.jpg">
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        window.Infuz.PageTransition.addPaneCallback(
            '<%= viewId %>',
            function() {
                window.Infuz.Utility.loadVideoContent($videoSection.get(), '36723314', 448, 252, true);
            }
        );
    });
</script>
